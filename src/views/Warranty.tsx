        ...
        <div className="max-w-[800px] mx-auto px-6 lg:px-8 space-y-12">
          ...
          <div className="bg-[#f5f5f5] border border-[#e5e5e5] p-6">
            ...
            <ul className="space-y-2 text-xs text-gray-600">
              ...
              <li>— Warranty registration strengthens your claim; <Link href="/warranty-registration" className="underline hover:text-white transition-colors">register your warranty here</Link>.</li>
