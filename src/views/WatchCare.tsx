      ...
      <section className="bg-black text-white py-14">
        <div className="max-w-[1300px] mx-auto px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/contact" className="bg-white text-black font-black text-xs uppercase tracking-widest px-8 py-3 hover:bg-gray-100 transition-colors">
              Contact Us
            </Link>
            <Link href="/warranty-registration" className="border border-white text-white font-black text-xs uppercase tracking-widest px-8 py-3 hover:bg-white hover:text-black transition-colors">
              Register Warranty
            </Link>
          </div>
        </div>
