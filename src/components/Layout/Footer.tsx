...
export default function Footer({ onNavigate }: FooterProps) {
  return (
    <footer className="relative bg-[#333333] text-white mt-auto overflow-hidden">
          ...
          <div className="lg:col-span-5">
            ...
            <div className="backdrop-blur-lg bg-white/10 border border-white/20 rounded-2xl p-6 mb-8 hover:bg-white/[0.15] transition-all group">
              <div className="flex items-start gap-4">
                ...
                <div className="leading-relaxed text-[#888888]">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <a
                ...
                className="backdrop-blur-md bg-white/90 hover:bg-white text-[#333333] border border-white/20 font-bold py-4 px-6 rounded-lg transition-all shadow-lg hover:shadow-2xl transform hover:scale-105 flex items-center justify-center gap-2"
              >
              ...
              <a
                ...
                className="backdrop-blur-md bg-white/10 border-2 border-white text-white hover:bg-white hover:text-[#333333] font-bold py-4 px-6 rounded-lg transition-all transform hover:scale-105 flex items-center justify-center gap-2"
              >
                <Phone size={20} />
                <span>Call Now</span>
              </a>
          ...
          <div className="lg:col-span-3">
                ...
                >
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1">
                      <div className="text-xs text-[#888888] mb-1">Email Us</div>
              ...
              <li>
                ...
                >
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1">
                      <div className="text-xs text-[#888888] mb-1">Call Us</div>
              ...
              <li>
                ...
                >
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1">
                      <div className="text-xs text-[#888888] mb-1">WhatsApp</div>
            ...
            <div className="mt-8 backdrop-blur-lg bg-white/10 border border-white/20 rounded-xl p-5">
              ...
              <div className="space-y-1">
                <div className="text-sm text-[#888888]">Mon - Sat: <span className="text-white">9:00 AM - 6:00 PM</span></div>
                <div className="text-sm text-[#888888]">Sunday: <span className="text-white">Closed</span></div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 relative">
          <div className="flex flex-col md:flex-row justify-between items-center gap-6">
            <div className="text-center md:text-left">
              <p className="text-[#888888] flex items-center gap-2 justify-center md:justify-start">
                <span>© {new Date().getFullYear()} Huke Times LLP. All rights reserved.</span>
              </p>
            </div>
            <div className="text-center md:text-right">
              <p className="text-xs text-[#888888] flex items-center gap-2 justify-center md:justify-end flex-wrap">
          ...
          <div className="mt-6 pt-6 border-t border-white/10 text-center">
            <p className="text-xs text-[#888888] flex items-center gap-2 justify-center">
              <span>Made with</span>
